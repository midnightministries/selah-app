  ...
  return (
    <span style={{ position: "relative", display: "inline-flex", marginLeft: 8, verticalAlign: "middle", visibility: show ? "visible" : "hidden", pointerEvents: show ? "auto" : "none" }}>
      <button onClick={(e) => { e.stopPropagation(); setOpen(o => !o); }} aria-label="Help"
        style={{ width: 21, height: 21, boxSizing: "border-box", borderRadius: "50%", border: "1px solid rgba(142,28,28,0.4)", background: "transparent", color: CROSS_RED, textShadow: "0 0 6px rgba(142,28,28,0.55)", fontFamily: "-apple-system, system-ui, sans-serif", fontSize: 13, fontWeight: 700, lineHeight: 1, cursor: "pointer", padding: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>?</button>
      {show && open && (
